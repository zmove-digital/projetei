...
| Imagens dos renders      | pasta `img/` (hero e portfólio) · galeria em WebP `img/galeria/modelo-01.webp` … `modelo-31.webp` + miniaturas `thumb-01.webp` … `thumb-31.webp` (JPGs originais arquivados fora do site, se precisar regerar) |
